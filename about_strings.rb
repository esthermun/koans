...
EOS
    assert_equal 53, long_string.length #has one more length...why?
    assert_equal 2, long_string.lines.count #new line for next line of text
    assert_equal "I", long_string[0,1]
  end
  ...
  def test_plus_equals_also_will_leave_the_original_string_unmodified
    ...
    there = "World"
    hi += there
    assert_equal "Hello, ", original_string # because only hi string is changed 
  end
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # because it will also modify all original strings without having to go back to target it
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised? Yeah~~ why does it work??
  end
